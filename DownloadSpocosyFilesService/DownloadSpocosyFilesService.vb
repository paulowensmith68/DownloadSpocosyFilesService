...
Public Class DownloadSpocosyFilesService
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        gobjEvent.WriteToEventLog("Service Start Banner:    *    DownloadSpocosyFilesService STARTING      *")
        gobjEvent.WriteToEventLog("Service Start Banner:    ************************************************")
...
Public Class Worker
    ...
    Public Sub StopWork()
        ...
        gobjEvent.WriteToEventLog("Service Stopping Banner: *    DownloadSpocosyFilesService STOPPED       *")
        gobjEvent.WriteToEventLog("Service Stopping Banner: ************************************************")
    ...
    Function StartProcess() As Boolean
        ...
        Try
            ...
            gobjEvent.WriteToEventLog("StartProcess:    *-----        DownloadSpocosyFilesService    -----")
            gobjEvent.WriteToEventLog("StartProcess:    *-------------------------------------------------")
